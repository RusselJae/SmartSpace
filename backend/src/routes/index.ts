...
import { reviewMediaRouter } from './review_media_route';
...
import { supportFormRouter } from './support_form_route';
...
import { inventoryMaterialRouter } from './inventory_material_route';

export const apiRouter = Router();

apiRouter.use('/health', healthRouter);
apiRouter.use('/products', productRouter);
apiRouter.use('/inventory-materials', inventoryMaterialRouter);
apiRouter.use('/users', userRouter);
apiRouter.use('/orders', orderRouter);
apiRouter.use('/reviews', reviewRouter);
apiRouter.use('/reviews/media', reviewMediaRouter);
...
apiRouter.use('/support/forms', supportFormRouter);
