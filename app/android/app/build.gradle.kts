...
android {
    namespace = "com.example.smartspace_ar"
    ...
    defaultConfig {
        ...
        applicationId = "com.example.smartspace_ar"
    ...
    buildTypes {
        release {
            // Use configured release key when key.properties exists.
            // Keep debug fallback so local builds still work without secrets.
